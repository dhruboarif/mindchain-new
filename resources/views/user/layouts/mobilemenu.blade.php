                ...
                <div class="all-feature-mobile mobile-screen-show">
                    ...
                    <div class="contents row">
                        <div class="col-sm-4 col-xs-12 ">
                            <div class="single">
                                <a href="">
                                    <div class="icon"><svg class="icon-wrap" width="25"
                                            height="25" viewBox="0 0 18 14" fill="none"
                                    ...
                                    <div class="name">Elite Member</div>
                                </a>
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-12 ">
                            <div class="single">
                                <a href="">
                                    <div class="icon"><svg class="icon-wrap" width="25"
                                            height="25" viewBox="0 0 20 17" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <div class="row contents">
                            ...
                            <div class="col-sm-4 col-xs-12 ">
                                <div class="single">
                                    <a href="">
                                        <div class="icon"><svg class="icon-wrap" width="25"
                                                height="25" viewBox="0 0 17 17" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <div class="col-sm-4 col-xs-12 ">
                                <div class="single">
                                    <a href="">
                                        <div class="icon"><svg class="icon-wrap" width="25"
                                                height="25" viewBox="0 0 16 14" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
