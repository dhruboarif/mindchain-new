                            ...
                            <button type="button" data-toggle="modal" data-target="#usdtDeposit" data-whatever=""  class="page-button">Pay Manually</button>
                                ...
                                <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                                              <div class="form-group" data-section="6">
                                                ...
                                                <select class="form-select form-control" id="selectWallet6" name="payment_wallet_id"  aria-label="Default select example" required onchange="selectWallet(6)">
                                              ...
                                              <div class="form-group" data-section="6">
                                                  ...
                                                  <input type="text" class="form-control" name="wallet_id2" disabled id="copyAddress6" readonly>
