                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bmind-card">
                                            <div class="card-box">
                                                <div class="card-icon">
                                                    <img src="{{ asset('assetsnew/img/img-icon/network.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bmind-card">
                                            <div class="card-box">
                                                <div class="card-icon">
                                                    <img src="{{ asset('assetsnew/img/img-icon/supply.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bmind-card">
                                            <div class="card-box">
                                                <div class="card-icon">
                                                    <img src="{{ asset('assetsnew/img/img-icon/current-price.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bmind-card">
                                            <div class="card-box">
                                                <div class="card-icon">
                                                    <img src="{{ asset('assetsnew/img/img-icon/next-price.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bmind-card">
                                            <div class="card-box">
                                                <div class="card-icon">
                                                    <img src="{{ asset('assetsnew/img/img-icon/current-stage.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bmind-card">
                                            <div class="card-box">
                                                <div class="card-icon">
                                                    <img src="{{ asset('assetsnew/img/img-icon/next-stage.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="card-content">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 bmind-stage-list ">
                                                <div class="card-box">
                                                    <div class="card-icon mg-t-15 mg-b-30">
                                                        <img src="{{ asset('assetsnew/img/img-icon/stage-icon.png') }}"
                                                            alt="">
                                                    ...
                                                    <div class="card-content mg-t-30">
                                                        <form>
                                                            <div class="form-group">
                                                                <label for="totalTokenIssued" class="col-form-label">Total
                                                                    Token Issued</label>
                                                                <input disabled type="text" class="form-control"
                                                                    value="{{ $row->total_token_issues }}">
                                                                <input type="text" class="form-control"
                                                                    id="totalTokenIssued" disabled value="30000000">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="availableTokens"
                                                                    class="col-form-label">Available Tokens</label>
                                                                <input type="text" class="form-control"
                                                                    id="availableTokens" disabled
                                                                    value="{{ $row->total_token_issues - $row->total_token_sell }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="tokenBasePrice" class="col-form-label">Token
                                                                    Base Price</label>
                                                                <input disabled type="text" class="form-control"
                                                                    id="token_base_price_{{ $row->title }}"
                                                                    value="{{ $row->token_base_price }}">

                                                            </div>
                                                            <div class="form-group">
                                                                <label for="bonusDuration" class="col-form-label">Bonus
                                                                    Duration (days)</label>
                                                                <input disabled type="text" class="form-control"
                                                                    value="{{ $row->duration }}">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="tokenAmount" class="col-form-label">Token
                                                                    Amount</label>
                                                                <select class="form-select finalamount" name="amount"
                                                                    id="amount_{{ $row->title }}" required
                                                                    onchange="updateSelectedAmount('{{ $row->title }}')">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="totalPrice" class="col-form-label">Total Price
                                                                    (USDT)</label>
                                                                <input disabled type="text"
                                                                    id="total_price_{{ $row->title }}"
                                                                    class="form-control"
                                                                    value="{{ $row->communityTokenPackageSettings->isNotEmpty() ? $row->communityTokenPackageSettings[0]->amount * $row->token_base_price : '' }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="dailyBonus" class="col-form-label">Daily
                                                                    Bonus</label>
                                                                <input disabled type="text" name="daily_bonus"
                                                                    class="form-control"
                                                                    id="daily_bonus_{{ $row->title }}"
                                                                    value="{{ $row->communityTokenPackageSettings->isNotEmpty() ? $row->communityTokenPackageSettings[0]->daily_bonus : '' }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="startDate" class="col-form-label">Start
                                                                    Date</label>
                                                                <input disabled type="text" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="endDate" class="col-form-label">End
                                                                    Date</label>
                                                                <input disabled type="text" class="form-control"
                                                                    value="{{ $row->end_date }}">
                                                        ...
                                                        @if ($row->status == 'Active')
                                                            <button type="button" class="btn btn-primary"
                                                                data-toggle="modal"
                                                                data-target="#bmindbuymodal{{ $row->id }}"
                                                                onclick="captureSelectedAmount('{{ $row->title }}')">Buy
                                                                B-Mind</button>
                                                            @include('user.modals.bmind.bmindbuymodal')
                                                        @else
                                                            <button type="button" class="btn btn-primary"
                                                                data-bs-toggle="modal" data-bs-target="#"
                                                                disabled>Upcoming</button>
                                                        @endif
